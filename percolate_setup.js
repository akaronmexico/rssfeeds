    ...
    profiles.forEach(item => {
        ...
        targets.forEach(target => {
            ...
            keywords.forEach(keyword => {
                ...
                inserts.push(insertDoc(indexName, partner + '_' + target.target + '_' + keyword.binId + '_' + keywordCounter, mappingName, json));
                // Target and Keyword
                json = {
                    "query": {
                        "query_string": {
                ...
                inserts.push(insertDoc(indexName, partner + '_' + target.target + '_' + keyword.binId + '_TANDK' + '_' + keywordCounter, mappingName, json));
                keywordCounter++;
            })
            targetCounter++;
        })
