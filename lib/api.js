...
exports.getAllByPartner = async () => {
  ...
  let lists = {};
  const sql = "SELECT partnerdata.*, partners.region, partners.subregion FROM partnerdata JOIN partners ON partners.partner = partnerData.partner order by score desc";
